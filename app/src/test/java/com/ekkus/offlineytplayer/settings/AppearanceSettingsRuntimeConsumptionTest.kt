...
class AppearanceSettingsRuntimeConsumptionTest {
    ...
    fun appearanceAndLibraryLayoutAreDurableAndConsumedByUi() {
        ...
        val theme = File("src/main/java/com/ekkus/offlineytplayer/ui/Theme.kt").readText()
        ...
        assertTrue(theme.contains("preference: AppearanceSetting = AppearanceSetting.System"))
        assertTrue(theme.contains("AppearanceSetting.System -> isSystemInDarkTheme()"))
        ...
        assertTrue(library.contains("onUpdateSettings"))
        assertTrue(library.contains("libraryLayout ="))
    }
}
