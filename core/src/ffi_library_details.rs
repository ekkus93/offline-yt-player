...
mod tests {
    ...
    fn details_include_source_assets_sizes_subtitles_and_integrity_metadata() {
        let item = LibraryItem {
            ...
            assets: vec![
                LocalAsset { asset_id: "video".into(), kind: MediaKind::Video, relative_path: "items/item-1/video.mp4".into(), bytes: 100, sha256: Some("digest".into()), mime_type: Some("video/mp4".into()) },
                LocalAsset { asset_id: "subtitle:en:human".into(), kind: MediaKind::Subtitle, relative_path: "items/item-1/subtitles/en.vtt".into(), bytes: 20, sha256: None, mime_type: Some("text/vtt".into()) },
            ],
