...
Current master `117e279485daa9c3dc56f8923f8bd29a9b169ea4` contains the production implementation and regression coverage. The implementation previously passed exact-head CI run `35913786091`, Android smoke `35913786133`, and Android FGS timeout `35913786001` on `11e2020268d0eb35ed59d341cd649c80e56534f5`; the first reconciliation branch also passed exact-head push/PR CI, Android smoke, and Android FGS timeout on `9fecca9777ee0e0aeb435236d15c350e5792396a`. This v2 branch replays the same evidence onto current master after PR #341 advanced the base. The canonical TODO must be checked only after this reconciliation evidence itself is qualified, merged, and observed on post-merge master CI.
